...
public class SearchCriteria {
    ...
    public static SearchCriteria createByBoth(String title, String contributor) {
        if (Validators.isBlank(title)) {
            throw new IllegalArgumentException("The search criteria of title cannot be empty.");
        }

        if (Validators.isBlank(contributor)) {
            throw new IllegalArgumentException("The search criteria of contributor cannot be empty.");
        }
